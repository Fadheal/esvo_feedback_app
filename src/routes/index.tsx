...
function App() {
  return (
    <main className="flex justify-center items-center h-screen relative">
      ...
      <div className='w-full h-fit md:max-w-110 md:min-h-135 rounded-4xl bg-background shadow-xl px-10 absolute border-solid border-foreground-muted border'>
        <div className='pt-7 pb-5 flex justify-between'>
          <h1 className='font-medium text-xl'>ESVO Feedback</h1>
          <ThemeToggle/>
        </div>
